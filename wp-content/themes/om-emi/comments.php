 ...
 * handled by a callback to om-emi_comment() which is
...
<div id="comments" class="row">
	<?php if ( post_password_required() ) : ?>
		<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'om-emi' ); ?></p>
	<?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * See om-emi_comment() in inc/functions/comments.php for more.
				 */
				wp_list_comments( array( 'callback' => 'om-emi_comment' ) );
			?>
		</ol>

		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
		<nav id="comment-nav-below">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'om-emi' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'om-emi' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'om-emi' ) ); ?></div>
		</nav>
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'om-emi' ); ?></p>
	<?php endif; ?>
